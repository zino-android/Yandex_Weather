...
public class ChangeCityPresenterTest {
    ...
    public void testOnClearClick() {
        ...
        verify(changeCityView).clearInput();
        verify(changeCityView).hideSuggestionList();
    }
    ...
    public void testLoadCitySuggestionError() {
        ...
        verify(changeCityView).showError();
    }
    ...
    public void testLoadCitySuggestionSuccess() {
        ...
        presenter.loadCitySuggestion(DEFAULT_CITY);
        testScheduler.triggerActions();
        verify(changeCityView).showSuggestions(citySuggestion.getPredictions());
        verify(changeCityView).showSuggestionList();
    }
    ...
    public void testOnCurrentCityChanged() {
        doThrow().doNothing().when(changeCityInteractor).setCurrentCity(any(Prediction.class));
        presenter.attachView(changeCityView);
        presenter.addNavigationManager(navigationManager);
        presenter.onCurrentCityChanged(new Prediction());
        verify(navigationManager).navigateTo(any());
        verify(changeCityInteractor).setCurrentCity(any(Prediction.class));
